...
MODEL_DIR = "/data/hdd1/users/kmparmp/experiment2/job/train/random/models/loger/asc_complexity/final_model"
FINAL_MODEL_PATH = os.path.join(MODEL_DIR, "20250524_193839_final_1.pkl")
FINAL_METADATA_PATH = os.path.join(MODEL_DIR, "20250524_193839_final_1_metadata.json")
FINAL_BASELINE_PATH = os.path.join(MODEL_DIR, "20250524_193839_final_1_baseline.pkl")
